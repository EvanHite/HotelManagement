...
export function Sidebar({ isMobile = false, onClose, onNavigate }) {
  const { notifications, session, roleLabels, logout } = useHotelApp();
      ...
      <div className="flex h-full flex-col px-4 py-5 sm:px-5">
        ...
        {isMobile && (
          <div className="mt-auto border-t border-slate-200 pt-4">
            <button
              className="flex h-10 w-full items-center justify-between rounded-md px-3 text-sm font-medium text-slate-700 hover:bg-slate-100 hover:text-slate-900"
              type="button"
            >
